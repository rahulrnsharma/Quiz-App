...
class InquiryThread {
    ...
    from: ObjectId;
    @Prop({ type: String, enum: RoleEnum, trim: true, required: true })
    role: string;
}
...
export class Inquiry extends Base {
    ...
    user: ObjectId;
    @Prop({ type: String, enum: InquiryTypeEnum, trim: true, required: true })
    type: String;
    @Prop({ type: String, enum: InquiryStatusEnum, default: InquiryStatusEnum.OPEN, trim: true, required: true })
    status: String;
